...
public class UserConstants {
    ...
    public static final Usuario INCORRECT_USER = new  Usuario(84,"","Sousa","250-76","11949793152", LocalDate.now(),LocalDate.now(),"123deoliveira4.com", PerguntaAtivo.NAO);
    ...
    public static final List<Usuario> EMPTY_USER_LIST = Collections.emptyList();
    ...
    public static final ResponseEntity<List<Usuario>> VALID_USERLIST_GETRESPONSE = ResponseEntity.status(HttpStatus.OK).body(Collections.singletonList(VALID_USER));
